...
```mermaid
gantt
    title Kim Junseok | AI Engineer Lifecycle (2025)
...
```mermaid
gantt
    title Kim Junseok | AI Engineer Lifecycle (2026)
    dateFormat  YYYY-MM-DD
    axisFormat  %m
    tickInterval 1month
...
- 정량/비전 AI 대회 다수 참가 및 상위권 성과
  ...
  - Hull Tactical - Market Prediction: 대회 최종 제출 완료 후, 제출 모델 기반 S&P500 실전 예측 6개월 운영 중 (26.6.17 종료 예정 | 3,340개 팀 중 58위 - 상위 1.7%)
...
| -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- | ------ |
| 📂 [Hull Tactical - Market Prediction](https://www.kaggle.com/competitions/hull-tactical-market-prediction/overview)                         | [S&P500 기반 리스크 제어형 자산배분 모델 개발 / **최종 제출 완료 + 실전 예측 운영 중(6개월 계획, 3개월 진행)**](https://github.com/junreud/quant) / **3340개 팀 중 58위** | 2025.09 ~ 2026.6.17(진행 중) | Kaggle |
| 📂 [HAI(하이)! - Hecto AI Challenge : 2025 하반기 헥토 채용 AI 경진대회](https://dacon.io/competitions/official/236628/overview/description) | [Vision-Language Model 기반 Deepfake Detection 모델 개발](https://github.com/junreud/dacon-deepfake) / **459개 팀 중 10위**                                               | 2025.12 ~ 2026.02            | DACON  |
| 📂 [Track1 알고리즘 부문 : K리그-서울시립대 공개 AI 경진대회](https://dacon.io/competitions/official/236647/overview/description)            | [ML 기반 축구공 좌표 예측 모델 개발](https://github.com/junreud/football) / **937개 팀 중 상위 10%**                                                                      | 2025.12 ~ 2026.01            | DACON  |
