...
- 정량/비전 AI 대회 다수 참가 및 상위권 성과
  ...
  - Quant Competition: 대회 최종 제출 완료 후, 제출 모델 기반 S&P500 실전 예측 6개월 운영 중 (현재 3개월 경과, 3,340개 팀 중 58위, 상위 1.7%)
...
|------|--------|------|------|
| 📂 [Quant Risk-Aware Allocation](https://github.com/junreud/quant) | S&P500 기반 리스크 제어형 자산배분 모델 개발 / **최종 제출 완료 + 실전 예측 운영 중(6개월 계획, 3개월 진행)** | 2026.01 ~ 진행 중 | Kaggle |
| 📂 [Deepfake Detection (VLM)](https://github.com/junreud/dacon-deepfake) | Vision-Language Model 기반 Deepfake Detection 모델 개발 / **459개 팀 중 10위** | 2025.12 ~ 2026.02 | DACON |
| 📂 [Soccer Ball Position Prediction](https://github.com/junreud/football) | ML 기반 축구공 좌표 예측 모델 개발 / **937개 팀 중 상위 10%** | 2025.12 ~ 2026.01 | DACON |
...
### 2) Quant Competition | Risk-Aware Allocation Pipeline
...
### 3) DACON | Deepfake Detection with Vision-Language Model
