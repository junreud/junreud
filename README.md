...
|------|--------|------|------|
| 📂 [Hull Tactical - Market Prediction](https://github.com/junreud/quant) | S&P500 기반 리스크 제어형 자산배분 모델 개발 / **최종 제출 완료 + 실전 예측 운영 중(6개월 계획, 3개월 진행)** / **3340개 팀 중 58위** | 2025.09 ~ 2026.6.17(진행 중) | Kaggle |
